...
{
    Task<Guid> AddAsync(string name, string email, string username, string phoneNumber, string passwordHash, UserRole role, bool isActive, CancellationToken cancellationToken);
    Task<List<User>> GetAllAsync(CancellationToken cancellationToken);
    Task<User?> GetByIdAsync(Guid id, CancellationToken cancellationToken);
    Task<bool> UpdateAsync(Guid id, string name, string email, string username, string phoneNumber, UserRole role, bool isActive, CancellationToken cancellationToken);
